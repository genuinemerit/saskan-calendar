...
from app import AstroCalendar, FatunikCalendar  # StrictLunarCalendar, LunarSolarCalendar
...
def test_fatunik_date(astro_day, expected_turn, expected_month,
                      day_of_month, expected_season, is_leap_turn,
                      expected_label, expected_event):
    """
    FATUNIK_EPOCH_DAY = 365472
    @TODO: Add tests for seaosonal events
    """
